...
/**
 * @program: Java-group
 * @description: apollo config 官方用例
 * @author: <a href="https://github.com/lcy2013">MagicLuo</a>
 * @create: 2020-06-24 10:46
 */
public class ApolloConfigDemo {
    ...
    public ApolloConfigDemo() {
        ...
        yamlConfig = ConfigService.getConfig("application.yml");
        yamlConfig.addChangeListener(changeListener);
        publicConfig = ConfigService.getConfig("TEST1.dev-2");
